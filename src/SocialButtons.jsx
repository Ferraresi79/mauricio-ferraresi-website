...
export default function SocialButtons({ className = "" }) {
  return (
    <div className={`flex flex-row gap-3 ${className}`}>
      ...
      >
        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
          <path d="M5.242 13.769L0 9.224 2.299 6.92l2.943 2.849L5.242 13.77zM24 9.224l-5.242 4.545-2.943-2.85L19.701 6.92 24 9.224zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22C6.486 22 2 17.514 2 12S6.486 2 12 2s10 4.486 10 10-4.486 10-10 10z"/>
        </svg>
        Google Scholar
      </a>
    </div>
